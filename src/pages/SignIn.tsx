      ...
      <main className="flex-grow flex items-center justify-center px-6 pt-20 pb-12">
        <div className="w-full max-w-[480px] z-10">
          ...
          <div className="text-center mb-10 space-y-2">
            ...
            <h2 className="font-headline-lg text-4xl font-bold text-on-background">Sign In</h2>
            <p className="text-body-md text-on-surface-muted">Access your OmniVision AI account</p>
          </div>
          ...
          <div className="glass-card p-8 rounded-xl relative">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  <label className="text-label-sm text-on-surface-muted block uppercase tracking-wider font-semibold" htmlFor="password">
                    Password
                  </label>
                  <a href="#" className="text-label-sm text-primary-light hover:text-primary-light/80 transition-colors font-semibold">
                    Forgot Password?
                  </a>
                </div>
                <div className="relative group">
            ...
            <p className="mt-6 text-center text-body-md text-on-surface-muted">
              ...
              <Link to="/signup" className="text-primary-light hover:text-primary-light/80 font-semibold transition-colors">
                Sign Up
              </Link>
            </p>
          </div>
