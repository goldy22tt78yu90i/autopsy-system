          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-6 sm:p-8">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full h-12 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 rounded-lg text-base font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
              >
